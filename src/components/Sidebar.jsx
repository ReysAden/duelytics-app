  ...
  return (
    ...
    >
      ...
      {isTabAvailable('active-session') && (
        <div style={getTabWrapperStyle('active-session')}>
      ...
      {isTabAvailable('archive') && (
        <div style={getTabWrapperStyle('archive')}>
      ...
      {isTabAvailable('background') && (
        <div style={getTabWrapperStyle('background')}>
      ...
      {isTabAvailable('decks') && (
        <div style={getTabWrapperStyle('decks')}>
      ...
      {isTabAvailable('create-session') && (
        <div style={getTabWrapperStyle('create-session')}>
      ...
      {isTabAvailable('manage-session') && (
        <div style={getTabWrapperStyle('manage-session')}>
